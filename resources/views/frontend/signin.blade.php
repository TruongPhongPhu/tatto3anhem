...
<body>
    <div class="form-container">
        ...
        <!--############# Register Form ###########-->
        <form id="registerForm" class="active"  action="{{URL::to('/login-customer')}}" method="POST">
            @csrf
            <div class="register-form">
                ...
                <div class="form-input">
                    <div class="input-box">
                        <input type="text" name="email_account" class="input-fileld" placeholder="Email" id="inputField" required>
                        <i class="fas fa-envelope"></i>
                        <p class="error-msg" style="color: red;"></p>
                    </div>
                    <div class="input-box">
                        <input type="password" name="password_account" class="input-fileld" placeholder="Password" id="ipnPasswordSignUp" on
